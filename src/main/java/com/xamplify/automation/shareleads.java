package com.xamplify.automation;
	...
	@Test(priority = 10, enabled = true)
		public void tiles() throws InterruptedException {
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='manageContacts']/div/div/div/div/div/div/div/div[2]/div[1]/button/span")).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='manageContacts']/div/div/div/div/div/div/div/div[2]/div[2]/button/span")).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='manageContacts']/div/div/div/div/div/div/div/div[2]/div[3]/button/span/a")).click();
			Thread.sleep(3000);
