...
//		actions1.moveToElement(email_gearicon).click().build().perform();
		...
		WebElement email_camp_folder_dropdown = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath(properties.getProperty("manage_email_camp_folder_dropdown")))); // Click
																														// on
																														// Folder
																														// Dropdown
		...
		WebElement email_camp_copy = driver.findElement(By.xpath(properties.getProperty("manage_email_camp_copy"))); // click
																														// on
																														// copy
		email_camp_copy.click();
		Thread.sleep(3000);
		logger.info("Click on copied successfully");
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_copy_save"))).click(); // copied
																										// successfully
		Thread.sleep(3000);
		...
		WebElement email_camp_update_enddate = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_update_enddate"))); // click on
																									// update_enddate
		email_camp_update_enddate.click();
		Thread.sleep(4000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_end_date"))).click(); // Click on enddate
																									// field
		Thread.sleep(3000);
		...
		WebElement email_camp_preview_delete = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_preview&delete"))); // click on Preview
																									// &delete
		...
		WebElement PD_sort = wait_PD_sortby.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(properties.getProperty("manage_email_camp_preview&delete_sortby")))); // select
		// dropdown
		Thread.sleep(2000);
		...
		WebElement email_sr1 = PD_search1.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(properties.getProperty("manage_email_camp_previewdelete_search"))));
		email_sr1.sendKeys("Automate");// data sent in search bar
		Thread.sleep(3000);

		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_previewdelete_search")))
				.sendKeys(Keys.ENTER);// click
		// enter
		Thread.sleep(3000);

		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_click_delete_under_preview&Delete")))
				.click(); // delete
		// partner
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ManageCamp_breadcrump"))).click();// click
																												// on
																												// manage
		// campaigns
		Thread.sleep(3000);
		...
		WebElement email_camp_archieve = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_archieve"))); // click on Archieve Camp
		email_camp_archieve.click();
		Thread.sleep(5000);
		logger.info("Click on archieved Campaign button");
		driver.findElement(By.xpath(properties.getProperty("manage_email_archievedcamp"))).click(); // Click on
																									// Archieved
																									// camapign button
		Thread.sleep(4000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_archievedcamp_settingsdropdown"))).click(); // Click
																														// on
																														// gearicon
		Thread.sleep(4000);
		logger.info("Click on Unarchieve Campaign");
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_unarchieve"))).click(); // Click on
																										// Unarchieve
																										// campaign
		Thread.sleep(4000);
		logger.info("Click on Active Campaigns");
		driver.findElement(By.xpath(properties.getProperty("manage_email_activecamp"))).click(); // Click on Active
																									// Campaigns
		Thread.sleep(4000);
		...
		WebElement email_delete_camp = driver.findElement(By.xpath(properties.getProperty("manage_email_delete_camp"))); // click
																															// on
																															// delete
																															// Camp
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_total_recepients_search_box")))
				.sendKeys("mounika");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_totalemailsent_search_box")))
				.sendKeys("mounika");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_totalemailsent_export_excel_icon_click")))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_totalemailsent_export_excel_click")))
				.click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Deliverability_search_box")))
				.sendKeys("mounika");
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Deliverability_search"))).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Deliverability_search_close"))).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Deliverability_export_excel_icon_click")))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Deliverability_export_excel_click")))
				.click();
		Thread.sleep(3000);
		...
		WebElement mange_email_camp_activerec = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_Activerecipients_click")));
		if (mange_email_camp_activerec.isEnabled()) {

			mange_email_camp_activerec.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Activerecipients_search_box")))
					.sendKeys("automated");
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Activerecipients_search"))).click(); // click
			// on
			// search
			Thread.sleep(3000);

			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Activerecipients_search_close")))
					.click();
			Thread.sleep(3000);
			WebDriverWait wait_time_drdn_2 = new WebDriverWait(driver, 50);
			WebElement w_time2 = wait_time_drdn_2.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(properties.getProperty("m_email_time_dropdown")))); // select
			// time
			// dropdown
			Thread.sleep(2000);
			...
			driver.findElement(
					By.xpath(properties.getProperty("manage_email_camp_Activerecipients_export_excel_icon_click")))
					.click();
			Thread.sleep(3000);
			driver.findElement(
		...
		if (openrat.isEnabled()) {
			openrat.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Openrate_search_box")))
					.sendKeys("automated");
			Thread.sleep(3000);
			...
			WebElement w_time = wait_time_drdn.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(properties.getProperty("m_email_time_dropdown1")))); // select
			// dropdown
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Openrate_export_excel_icon_click")))
					.click();
			Thread.sleep(5000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_Openrates_export_excel_click")))
					.click();
			Thread.sleep(3000);
		...
		WebElement clickedurl = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedURL_click")));
		if (clickedurl.isEnabled()) {

			clickedurl.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedURL_search_box")))
					.sendKeys("automated");
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedURL_search"))).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedURL_search_close"))).click();
			Thread.sleep(3000);

			WebDriverWait wait_time_drdn_3 = new WebDriverWait(driver, 50);
			WebElement w_time3 = wait_time_drdn_3.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(properties.getProperty("m_email_time_dropdown2")))); // select
																												// time
																												// dropdown
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedURL_export_excel_icon_click")))
					.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedURLs_export_excel_click")))
					.click();
			Thread.sleep(3000);
		...
		WebElement clickthroughrate = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedThroughRate_click")));
		if (clickthroughrate.isEnabled()) {

			clickthroughrate.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedThroughRate_search_box")))
					.sendKeys("automated");
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedThroughRate_search"))).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_ClickedThroughRate_search_close")))
					.click();
			Thread.sleep(3000);

			WebDriverWait wait_time_drdn_3 = new WebDriverWait(driver, 50);
			WebElement w_time3 = wait_time_drdn_3.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(properties.getProperty("mv_time_dropdown3")))); // select
																											// time
																											// dropdown
			Thread.sleep(2000);
			...
			driver.findElement(
					By.xpath(properties.getProperty("manage_email_camp_ClickedThroughRate_export_excel_icon_click")))
					.click();
			Thread.sleep(3000);
			driver.findElement(
					By.xpath(properties.getProperty("manage_email_camp_ClickedThroughRate_export_excel_click")))
					.click();
			Thread.sleep(3000);
		...
		WebElement hardbounce = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_Hardbounce_click")));
		...
		WebElement softbounce = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_Softbounce_click")));
		...
		WebElement unsubscribe = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_Unsubscribe_click")));
		...
		WebElement email_camp_leads = driver
				.findElement(By.xpath(properties.getProperty("manage_email_camp_leads_click")));

		if (email_camp_leads.isEnabled()) {
			email_camp_leads.click();
			Thread.sleep(5000);

			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_leads_search_box")))
					.sendKeys("auto_lead");
			Thread.sleep(6000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_leads_search"))).click();
			// Search icon click
			Thread.sleep(3000);
			...
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_click_lead_filter"))).click(); // Click
																													// on
																													// filter
			Thread.sleep(3000);

			WebDriverWait wait_statusdropdown = new WebDriverWait(driver, 50);
			WebElement w_leadstatusdropdown = wait_statusdropdown.until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath(properties.getProperty("manage_email_camp_click_leadstatus_select_dropdown"))));
//			Thread.sleep(2000);
			...
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_click_leadfilter_button"))).click(); // click
																														// on
																														// filter
																														// button
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_click_leadfilter_cross_click")))
					.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_leads_download_click"))).click(); // Click
																													// on
																													// Download
			Thread.sleep(5000);
		...
		WebElement deals = driver.findElement(By.xpath(properties.getProperty("manage_email_camp_deals_click"))); // Click
																													// on
																													// Deals
																													// tile
		...
		if (deals.isEnabled()) {
			deals.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_deals_search_box")))
					.sendKeys("auto_deal");
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_deals_search"))).click();
			// Search icon click
			Thread.sleep(3000);
			...
			Thread.sleep(3000);
			logger.info("Click on filter");
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_click_deals_filter"))).click(); // Click
																													// on
																													// filter
			Thread.sleep(3000);

			WebDriverWait wait_dealstatusdropdown = new WebDriverWait(driver, 50);
			WebElement w_dealstatusdropdown = wait_dealstatusdropdown
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("manage_email_camp_click_dealsfilter_cross_click")))
					.click();
			Thread.sleep(3000);
		...
		WebElement email_sort = wait_eml_camp_sortby.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(properties.getProperty("manage_email_camp_total_email_camp_sort_by")))); // select
		// totla
		// email
		// opned_dropdown
		Thread.sleep(2000);
		...
		WebElement email_open_sort = wait_email_open_history_sortby.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(properties.getProperty("manage_emailcamp_openhistorybytemplate_soryby_click")))); // select
		// email
		...
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_openhistorybytemplate_searchbox_click")))
				.sendKeys("Automated");
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_openhistorybytemplate_searchicon_click")))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_openhistorybytemplate_search_close")))
				.click();
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_showdownloadhistory_click"))).click(); // click
																													// on
																													// Show
		// download
		// history icon
		...
		WebDriverWait email_camp_show_download_history_sortby = new WebDriverWait(driver, 50);
		WebElement email_camp_downloadhistory__sort = email_camp_show_download_history_sortby
				.until(ExpectedConditions.visibilityOfElementLocated(
						By.xpath(properties.getProperty("manage_emailcamp_showdownloadhistory_soryby_click")))); // select
		...
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_showdownloadhistory_searchbox_click")))
				.sendKeys("Automated");
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_showdownloadhistory_searchicon_click")))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("manage_emailcamp_showdownloadhistory_search_close")))
				.click(); // clear data
		Thread.sleep(5000);
