...
//		Thread.sleep(3000);
		...
		driver.findElement(By.xpath(properties.getProperty("mv_analytics_icon_click"))).click(); // Click on Campaign based
																								// Reports
		Thread.sleep(3000);
		...
		if (openrat.isEnabled()) {
			...
			WebElement w_time = wait_time_drdn.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty("mv_time_dropdown")))); // select
																														// dropdown
			Thread.sleep(2000);
		...
		if (activerec.isEnabled()) {
			...
			driver.findElement(By.xpath(properties.getProperty("mv_emails_opened_by_recepients_search_box")))
					.sendKeys("automated");
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("mv_emails_opened_by_recepients_search"))).click(); //click on search
			Thread.sleep(3000);
		...
		if (clickedurl.isEnabled()) {
			...
			clickedurl.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath(properties.getProperty("mv_recepients_clicked_search_box"))).sendKeys("automated");
			Thread.sleep(3000);
			...
			WebElement w_time3 = wait_time_drdn_3.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty("mv_time_dropdown1")))); // select
																														// time
																														// dropdown
			Thread.sleep(2000);
...
//				
		...
		WebElement s_analytics_search = driver.findElement(By.xpath(properties.getProperty("mv_analytics_search")));
