...
public class PartnerManageSurveyCampaign {
	...
	public void manage_redsurveycamp() throws InterruptedException {
		...
		WebElement eml_sort = wait_eml_sortby.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(properties.getProperty("re_surveycamp_total_email_camp_sort_by")))); // select total email opned_dropdown
		Thread.sleep(2000);
...
//		lead_lastname.clear();
		...
		WebElement address = driver.findElement(By.xpath(properties.getProperty("click_on_address")));
		address.clear();
		Thread.sleep(2000);
		address.sendKeys("Lead_Address");
		Thread.sleep(2000);
		WebElement city = driver.findElement(By.xpath(properties.getProperty("click_on_city")));
		city.clear();
		Thread.sleep(2000);
		city.sendKeys("Hyderabad");
		Thread.sleep(2000);
		WebElement state = driver.findElement(By.xpath(properties.getProperty("click_on_state")));
		state.clear();
		Thread.sleep(2000);
		state.sendKeys("Telangana");
		Thread.sleep(2000);
		WebElement postalcode = driver.findElement(By.xpath(properties.getProperty("click_on_postalcode")));
		postalcode.clear();
		Thread.sleep(2000);
		postalcode.sendKeys("500050");
		WebElement phone = driver.findElement(By.xpath(properties.getProperty("click_on_phonenum")));
		phone.clear();
		Thread.sleep(2000);
		...
		if (leads.isEnabled()) {
			...
			WebElement sel_deal_pipeline = wait_dealpipeline_dropdwn.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(properties.getProperty("click_pipeline_dropdown")))); //Select Stage
