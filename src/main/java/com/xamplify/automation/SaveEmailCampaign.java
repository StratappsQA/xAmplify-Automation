...
public class SaveEmailCampaign   {
	...
	public void esave() throws InterruptedException, SQLException
	{
		...
		// Thread.sleep(3000);
			  ...
			  Thread.sleep(5000);
			  driver.findElement(By.xpath(properties.getProperty("e_mailid"))).sendKeys(
			  "agayatri@stratapps.com"); //send to any mail id
			  ...
			  WebDriverWait w7 = new WebDriverWait(driver, 30); WebElement we7 = w7.until(
			  ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty
			  ("esave_insidespamcheck")))); we7.click();
			  
			  Thread.sleep(7000);
			  
			  driver.findElement(By.xpath(properties.getProperty("esave_inside_refresh"))).
			  click(); 
			  Thread.sleep(7000);
			  
			  
			  
			  driver.findElement(By.xpath(properties.getProperty("esave_spam_close"))).
			  click(); 
			  Thread.sleep(7000);
