...
public class ManageSurveyCampaign extends ExtentReportsClass {
	...
	public void manage_scampaign() throws InterruptedException, SQLException {
		...
		driver.findElement(By.xpath(properties.getProperty("preview&delete_partner"))).click(); // Click on Preview and
																								// delete
		Thread.sleep(3000);
		...
		WebElement w_sort = wait_sortby
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty("ms_sortby")))); // select
																														// dropdown
		Thread.sleep(2000);
...
//		Thread.sleep(3000);
		...
		WebElement sr1 = search1.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath(properties.getProperty("survey_previewdelete_search"))));
...
//		Thread.sleep(5000);
		...
		if (openrat.isEnabled()) {
			...
			WebElement w_time = wait_time_drdn.until(
		...
		if (activerec.isEnabled()) {
			...
			WebElement w_time2 = wait_time_drdn_2.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty("time_dropdown")))); // select
																														// time
																														// dropdown
			Thread.sleep(2000);
...
//				
			...
			WebElement w_dstatusdropdown = wait_dealstatusdropdown.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(properties.getProperty("status_select_dropdown2"))));
			Thread.sleep(2000);
		...
		driver.findElement(By.xpath(properties.getProperty("email_open_history_by_template"))).click(); // click on
		...
		Thread.sleep(5000);
		logger.info("Clicked on the Survey tab");
		driver.findElement(By.xpath(properties.getProperty("show_download_history"))).click(); // click on Show download
																								// history icon
		Thread.sleep(3000);
