...
reports = new ExtentReports(System.getProperty("user.dir") + "/test-output/xAmplify-AutomationReports.html", true);

reports.addSystemInfo("Host Name", "xAmplify Automation")
.addSystemInfo("Environment", "Server")
.addSystemInfo("User Name", "QA Team");
reports.loadConfig(new File(System.getProperty("user.dir")+"/test-output/extent-config.xml"));
}

@Test
public void  StartofAutomationProcess(){
