...
public void manage_event_editdelete() throws InterruptedException, SQLException {
	...
	WebElement meve_drop=driver.findElement(By.xpath(properties.getProperty("meve_edit_selectfolder"))); //click on the folder
	meve_drop.click();
	...
	driver.findElement(By.xpath(properties.getProperty("meve_copycampaign"))).click(); //click on the copy campaign icon

	Thread.sleep(3000);

	driver.findElement(By.xpath(properties.getProperty("meve_copy_saveas"))).click(); //click on the save the copycampaign
...
public void manage_eve_sndpreview_update() throws InterruptedException, SQLException {
	...
	driver.findElement(By.xpath(properties.getProperty("meve_sendpreviewemail"))).click(); //click on the sendpreview mail option

	Thread.sleep(3000);
	
	WebElement snddata=driver.findElement(By.xpath(properties.getProperty("meve_senddata"))); //click on the emailid field
	...
	driver.findElement(By.xpath(properties.getProperty("meve_preview_closeicon"))).click(); //click on the close icon
	...
	driver.findElement(By.xpath(properties.getProperty("meve_updateevent_option"))).click(); //click on the update event option
	Thread.sleep(3000);
    ...
    Thread.sleep(3000);
	driver.findElement(By.xpath(properties.getProperty("meve_update_button"))).click();  //click on the update button
	Thread.sleep(58000);
...
public void manage_eve_grid_cancel() throws InterruptedException, SQLException {
	...
	WebElement w=driver.findElement(By.xpath(properties.getProperty("meve_hover_canceleventicon"))); //hover to cancelevent icon
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath(properties.getProperty("meve_cancel_emailsubject"))).sendKeys("event cancelled subject"); //click on the 
	Thread.sleep(3000);
	driver.findElement(By.xpath(properties.getProperty("meve_cancel_message"))).sendKeys("event cancelled due to some reasons"); //click on the 
	Thread.sleep(3000);
	driver.findElement(By.xpath(properties.getProperty("meve_cancel_event"))).click(); //click on the cancel event button
	Thread.sleep(58000);
