...
public class SurveyToCampaign {
	...
	public void scampaign() throws InterruptedException, SQLException {
		...
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_pre-header")))
				.sendKeys("pre-Header for Survey To-campaign");
		Thread.sleep(2000);
		...
		WebElement w_dropdown = wait_dropdown.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath(properties.getProperty("s_to_camp_select_dropdown")))); // select
																												// dropdown
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_search_data"))).sendKeys("mnmnmnmnmn"); // give
																												// invalid
																												// text
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_search_Valid_data"))).sendKeys("Automatedvendor"); // give
																															// Valid
																															// text
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_searchButton_click"))).click(); // click on Search
																										// button
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_select_partnerlist"))).click(); // Slect the
																										// Partner list
		Thread.sleep(5000);
		logger.info("click on preview_Partner_list ");
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_preview_partner_list"))).click(); // click on
																										// Preview Icon
		Thread.sleep(5000);
  	...
  	logger.info("Goto Email_Template_Section");
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_template_preview"))).click(); // click on Preview
																									// icon
		Thread.sleep(3000);
		driver.findElement(By.xpath(properties.getProperty("s_to_camp_template_preview_close"))).click();
		Thread.sleep(3000);
		// driver.findElement(By.xpath(properties.getProperty("s_to_camp_template_edit"))).click();
		// // click on Edit template Icon
		// Thread.sleep(9000);
		WebDriverWait edit = new WebDriverWait(driver, 80);
		WebElement edit1 = edit.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath(properties.getProperty("s_to_camp_template_edit"))));
		edit1.click();
		Thread.sleep(15000);
