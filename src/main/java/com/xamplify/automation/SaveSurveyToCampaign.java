...
logger.info("Click on Save");
	...
	Thread.sleep(3000);
	driver.findElement(By.xpath(properties.getProperty("s_to_camp_sendTextBox"))).sendKeys("chmounika@stratapps.com");
	Thread.sleep(3000);
	...
	WebElement spam11 = spam1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty
			  ("s_to_campsave_insidespamcheck")))); spam11.click();
	...
	driver.findElement(By.xpath(properties.getProperty("s_to_camp_save1"))).click(); // Click on Save
 	...
 	String s_to_camp_save = driver.findElement(By.xpath(properties.getProperty("s_to_camp_response_msg"))).getText(); // response
	// message
