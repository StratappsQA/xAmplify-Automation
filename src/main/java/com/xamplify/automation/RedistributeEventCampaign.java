...
public class RedistributeEventCampaign extends ExtentReport {
	...
	public void hoverRedistributecampaigns_event() throws InterruptedException {
		...
		driver.findElement(By.xpath(properties.getProperty("partner_redistribute_eve_camp_preview"))).click(); // click on
		// preview
		Thread.sleep(6000);

		logger.info("Event tab preview clicked successfully");

		driver.findElement(By.xpath(properties.getProperty("partner_redistribute_eve_camp_preview_close"))).click(); // click on
...
Thread.sleep(4000);
driver.findElement(By.xpath(properties.getProperty("partner_eve_redis_viewdwnld_history"))).click(); // click on history

Thread.sleep(4000);
logger.info("Event view download history clicked successfully");
driver.findElement(By.xpath(properties.getProperty("partner_eve_redis_viewdwnld_history_close"))).click(); // click on history
...
sndata.sendKeys("agayatri@stratapps.com");
...
driver.findElement(By.xpath(properties.getProperty("partneracc_m_eve_sendbutton"))).click();
Thread.sleep(4000);
